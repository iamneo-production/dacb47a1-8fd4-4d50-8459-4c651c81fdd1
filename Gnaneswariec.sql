...
--query to find total count of female candidates participating in each year----#
 ...
 select partyname
 from (select rownum as slno,partyname
...
from ELECTION
where st_name='Haryana' and year=1996 and PARTYABBRE='BJP'
group by st_name,year;
...
HAVING PARTYABBRE = 'INC' AND YEAR = 1984  
...
ST_NAME = 'Kerala' AND PARTYNAME = 'INC'
